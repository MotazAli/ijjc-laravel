...
<div class="overflow-x-auto  shadow-md sm:rounded-lg">
    <div x-data="{dropdownAction:false}" class="flex justify-between items-center p-4  border-colors-theme colors-theme ">
        ...
        <div class="relative">
            ...
            <input type="text" id="table-search-users" class="block p-2 pl-10 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-600 dark:placeholder-gray-100 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for users">
        </div>
    </div>
    <table class="w-full text-sm text-left colors-theme">
        ...
        @foreach ( $users as $user )
            <tr wire:click="userClickHandler({{ $user }})" class=" cursor-pointer border-b border-colors-theme colors-theme hover:bg-gray-100 dark:hover:bg-gray-600">
                {{-- <td class="p-4 w-4">
                    <div class="flex items-center">

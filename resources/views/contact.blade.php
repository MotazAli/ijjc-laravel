    ...
    <div class="flex justify-center p-10">
       <div class="flex flex-wrap lg:justify-between -mx-4">
                ...
                <div class="flex mb-8 max-w-[370px] w-full">
                   ...
                   <div class="w-full">
                      ...
                      <p class="text-base text-body-color">
                        Yasmin 4 villa 7, Ja'far ibn Abi Talib - 1st settlement - New Cairo 1
                      </p>
                   </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                   ...
                   <div class="w-full">
                      ...
                      <p class="text-base text-body-color">
                        <a href="tel:201157076291">(+20)115 707 6291</a>
                    </p>
                   </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                   ...
                   <div class="w-full">
                      ...
                      <p class="text-base text-body-color">
                        <a href="mailto:inter.jjc@gmail.com">inter.jjc@gmail.com</a>
                    </p>
                   </div>
                </div>
             </div>
          ...
          <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
             <div class=" colors-theme  bg-gray-50  dark:border-themes-borderDark border-[0.5px]  rounded-lg p-8 sm:p-12 shadow-lg">
                <form>
                   <div class="mb-6">
                      <input
                         type="text"
                         placeholder="Your Name"
                         class="bg-gray border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-600 dark:placeholder-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                         />
                   </div>
                   <div class="mb-6">
                      <input

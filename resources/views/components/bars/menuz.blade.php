...
<div x-show="showMenu" 
  ...
  <div class=" overflow-y-auto py-4 px-3 h-screen  border-gray-50 dark:border-gray-400 border-solid border-l-[0.5px] border-b-[0.5px]  bg-gray-100  dark:bg-gray-800">
